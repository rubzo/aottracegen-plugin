...
public class CodeGenerator {
	...
	private void emitSharedObjectITrace(CodeGenContext context, String iTraceSName, String iTraceOName, String iTraceSOName) throws CommandException {
		String assembleCommand = String.format("arm-linux-androideabi-gcc -march=armv7-a -mfloat-abi=hard -mfpu=neon -mthumb -c -fno-rtti -fPIC -o %s %s", iTraceOName, iTraceSName);
